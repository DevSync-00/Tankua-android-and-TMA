    ...
    <main className="min-h-screen bg-[#f7f5f0]">
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-[#181714]/70 max-w-3xl mx-auto">
        ...
        <Card className="p-8 mb-8">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <h2 className="text-2xl font-semibold text-[#181714] mb-3">
                Existing Provider
              </h2>
            ...
            <div>
              ...
              <Link href={providerRegisterUrl}>
                <Button variant="outline" className="border-[#A67C52]/30 text-[#181714]">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            ...
            <div key={item} className="flex items-center gap-2 text-[#181714]/80">
