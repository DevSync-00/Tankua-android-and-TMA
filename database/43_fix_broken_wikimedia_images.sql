-- ========================================================
-- FIX BROKEN WIKIMEDIA/WIKIPEDIA IMAGES FOR DESTINATIONS
-- Run this migration in the Supabase SQL editor to replace broken or blocked
-- Wikimedia/Wikipedia URLs with high-quality Unsplash category placeholders.
-- ========================================================

-- 1. Update religious/sacred/church destinations
UPDATE public.destinations
SET images = ARRAY[
  'https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=800', -- Axum St. Mary
...
-- 2. Update historical/monument/museum/cultural destinations
UPDATE public.destinations
...
-- 3. Update nature/park destinations
UPDATE public.destinations
SET images = ARRAY[
...
-- 4. Update adventure destinations
UPDATE public.destinations
...
-- 5. Update city destinations
UPDATE public.destinations
SET images = ARRAY['https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=800'] -- Addis Ababa
WHERE (images IS NULL OR images = '{}'::text[] OR array_length(images, 1) IS NULL OR images[1] LIKE '%wikimedia.org%' OR images[1] LIKE '%wikipedia.org%')
  AND (category = 'city');

-- 6. Update any other remaining destinations with a default placeholder
UPDATE public.destinations
